    ...
    >
      ...
      <div className="min-w-0 flex-1 pt-0.5">
        <div className="flex items-center gap-2">
          <p className="truncate text-[14px] font-medium leading-[1.3] text-[#202124]">{meta.label}</p>
          {count > 0 ? (
            <span
        ...
        <p className="line-clamp-1 mt-1 overflow-hidden text-[13px] leading-[1.2] tracking-normal text-[#5f6368]">
          {senderPreview}
        </p>
      </div>
    </Link>
